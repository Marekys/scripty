...
(function() {
    ...
    if (!window.location.href.includes('screen=map')) {
        ...
        if (typeof TWMap !== 'undefined') {
            ...
            // Create "Redraw" button UI
            function createRedrawButton() {
                if (!document.getElementById("highlightRedrawButton")) {
                    var button = document.createElement("button");
                    button.id = "highlightRedrawButton";
                    button.textContent = "Redraw Villages";
            ...
            // Function to highlight all villages in green
            ...
            // Add the Redraw button to the UI
            createRedrawButton();

            // Initialize highlight function if needed
