...
(function() {
    ...
    button.innerHTML = 'Highlight Villages';
        ...
        if (!window.location.href.includes('screen=map')) {
            ...
            if (typeof TWMap !== 'undefined') {
                ...
                if (typeof mapOverlay.mapHandler._spawnSector === 'function') {
                    ...
                    console.error("mapOverlay.mapHandler._spawnSector is not a function. Please make sure the map is fully loaded before running this script.");
                }
            } else {
