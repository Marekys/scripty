                ...
                .done(function (page) {
                    ...
                    if ($("#mobileHeader")[0]) {
                        ...
                        for (let i = 0; i < allVillages.length; i++) {
                            ...
                            const available = parseInt(allMerchants[i].innerText.match(/\d+/)[0], 10); // extract first number
                            availableMerchants.push(available);
                            
                            const adjustedTotal = Math.ceil(available * 1.5); // simulate 50% premium bonus
                            totalMerchants.push(adjustedTotal.toString());
